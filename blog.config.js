...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'koloz', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.7data7.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字化转型, 数据治理, 企业架构, AI应用, 数据中台, 指标体系, 数据资产, 智能管理, 数据文化', // 网站关键词 英文逗号隔开
